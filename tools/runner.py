...
def run_web(args):
    if not EMSCRIPTEN_ROOT:
        ...
        print('Please install emscripten.')
        print('If /usr/lib/emscripten/ is not your installation path, set the EMSCRIPTEN environment variable to point to the path of your installation')
        sys.exit(1)
