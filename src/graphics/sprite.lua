...
function drystal.new_sprite(source, x, y, w, h)
	local sprite = setmetatable({data={}}, Sprite)
	sprite.source = source
	sprite.data.x = x or 0
	sprite.data.y = y or 0
	sprite.data.w = w or source.w
	sprite.data.h = h or source.h
	return sprite
end
